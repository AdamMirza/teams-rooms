...
export interface IRoomsTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IRoomsTabRemoveProps {

}

/**
 * Implementation of Rooms remove page
 */
export class RoomsTabRemove  extends TeamsBaseComponent<IRoomsTabRemoveProps, IRoomsTabRemoveState> {
